...
- **Programming & ML** — Python (pandas, scikit-learn, statsmodels, numpy), R, SPSS, SQL, Qualtrics; NLP, classification, LLM benchmarking, explainable AI, sentiment analysis.
